...
const Field = ({ value, onChange, placeholder, show, onToggle }) => (
  <div className="relative">
    ...
    <input
      ...
      className="w-full h-14 pl-12 pr-14 rounded-2xl border border-slate-300 focus:border-emerald-700 focus:ring-4 focus:ring-emerald-100 outline-none text-slate-800 placeholder-slate-400 transition"
    />
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 p-8">
        <div className="w-11 h-11 rounded-2xl bg-emerald-800 flex items-center justify-center mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading}
            className="w-full h-14 rounded-2xl bg-emerald-800 hover:bg-emerald-900 disabled:opacity-60 text-white font-medium flex items-center justify-center gap-2 transition">
