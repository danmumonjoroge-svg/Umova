...
export default function POSAccountStatus({ stage }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden text-center">
        <div className="h-1.5 bg-gradient-to-r from-emerald-800 via-emerald-700 to-amber-400" />
        <div className="p-8">
